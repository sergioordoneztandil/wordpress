<?php
    ...
    $args = array(
        ...
        'menu_type'            => 'menu',
        'menu_icon'            => get_template_directory_uri().'/images/teracode-options.png',
        //Specify if the admin menu should appear or not. Options: menu or submenu (Under appearance only)
        'allow_sub_menu'       => false,
        // Show the sections below the admin menu item or not
        'menu_title'           => esc_html__( 'Teracode Options', 'advisor' ),
        'page_title'           => esc_html__( 'Teracode Options', 'advisor' ),
    ...
    'icon'             => 'el el-home',
		'fields'           => array(
            ...
            array(
                'id'        => 'advisor-header-logo-scroll',
                'type'      => 'media',
                'title'     => esc_html__( 'Logo Scroll', 'advisor' ),
                'compiler'  => 'true',
                'mode'      => false,
                'desc'      => esc_html__('Please Upload Logo','advisor')
              ),
              array(
                'id'        => 'advisor-header-video',
                'type'      => 'media',
                'title'     => esc_html__( 'Header Video', 'advisor' ),
                'compiler'  => 'true',
                'mode'      => false,
                'desc'      => esc_html__('Please Upload Video','advisor')
              ),
              array(

                'id'       => 'advisor-header-video-title',
                'type'     => 'text',
                'title'    => esc_html__( 'Video title', 'advisor' ),
                'desc'     => __( 'Video title on header.', 'advisor' ),
       
             ),
             array(

                'id'       => 'advisor-header-video-subtitle',
                'type'     => 'text',
                'title'    => esc_html__( 'Video subtitle', 'advisor' ),
                'desc'     => __( 'Video subtitle on header.', 'advisor' ),
